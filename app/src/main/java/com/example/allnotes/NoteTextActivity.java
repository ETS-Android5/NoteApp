...
public class NoteTextActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        drawerLayout = findViewById(R.id.draw_layout_text);
        navigationView = findViewById(R.id.nav_view_text);
...
//        GoogleSignInAccount account = GoogleSignIn.getLastSignedInAccount(this);
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        switch(item.getItemId()){
            case R.id.nav_home:
                startActivity(new Intent(NoteTextActivity.this, ContentMain.class));
                break;
            case R.id.nav_draw:
                startActivity(new Intent(NoteTextActivity.this, DrawActivity.class));
                break;
            case R.id.nav_image:
                startActivity(new Intent(NoteTextActivity.this, ImageNoteActivity.class));
                break;
            case R.id.nav_file:
                Intent intent = new Intent(NoteTextActivity.this, FileNoteActivity.class);
                startActivity(intent);
                break;
            case R.id.nav_text:
                startActivity(new Intent(NoteTextActivity.this,NoteTextActivity.class));
                break;
